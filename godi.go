...
char* get_mnemonic_name(int index) {
	return GET_MNEMONIC_NAME(index);
}

char* get_register_name(int index) {
	return GET_REGISTER_NAME(index);
}
...
const (
	...
	I_VCMPFALSESS    = 5646
	I_VCMPFALSE_OSPD = 5453
	I_VCMPFALSE_OSPS = 5051
	I_VCMPFALSE_OSSD = 6257

	I_VCMPFALSE_OSSS = 5855
	I_VCMPGEPD       = 5271
	I_VCMPGEPS       = 4869
	I_VCMPGESD       = 6075
	...
	I_VCMPTRUESS    = 5693
	I_VCMPTRUE_USPD = 5509
	I_VCMPTRUE_USPS = 5107
	I_VCMPTRUE_USSD = 6313

	I_VCMPTRUE_USSS = 5911
	I_VCMPUNORDPD   = 5152
	I_VCMPUNORDPS   = 4750
	I_VCMPUNORDSD   = 5956

	I_VCMPUNORDSS   = 5554
	I_VCMPUNORD_SPD = 5342
	I_VCMPUNORD_SPS = 4940
	I_VCMPUNORD_SSD = 6146

	I_VCMPUNORD_SSS = 5744
	I_VCOMISD       = 2830
	I_VCOMISS       = 2821
	I_VCVTDQ2PD     = 6853
	...
	I_VFMADDSUB132PD = 8360
	I_VFMADDSUB132PS = 8344
	I_VFMADDSUB213PD = 8640

	I_VFMADDSUB213PS = 8624
	I_VFMADDSUB231PD = 8920
	I_VFMADDSUB231PS = 8904
	...
	I_VFMSUBADD132PD = 8392
	I_VFMSUBADD132PS = 8376
	I_VFMSUBADD213PD = 8672

	I_VFMSUBADD213PS = 8656
	I_VFMSUBADD231PD = 8952
	I_VFMSUBADD231PS = 8936
...
func (v *Value) SWord() int16 {
	return int16(binary.LittleEndian.Uint16(v.Mem[:]))
}

func (v *Value) Word() uint16 {
	return binary.LittleEndian.Uint16(v.Mem[:])
}

func (v *Value) SDword() int32 {
...
func (v *Value) SQword() int64 {
	return int64(binary.LittleEndian.Uint64(v.Mem[:]))
}

func (v *Value) Qword() uint64 {
	return binary.LittleEndian.Uint64(v.Mem[:])
}

func (v *Value) Addr() OffsetType {
	return OffsetType(v.Qword())
}

func (v *Value) Ptr() *ValuePtr {
	return (*ValuePtr)(unsafe.Pointer(&v.Mem[0]))
}

func (v *Value) Ex() *ValueEx {
	return (*ValueEx)(unsafe.Pointer(&v.Mem[0]))
}
...
func MnemonicString(Opcode uint16) string {
	return C.GoString(C.get_mnemonic_name(C.int(Opcode)))
}

func RegisterString(Register uint8) string {
	return C.GoString(C.get_register_name(C.int(Register)))
}
